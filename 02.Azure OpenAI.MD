...
* Generate, build, and run a sample
    * Streaming
    ```
      ...
      python main.py
    ```
    * <a href ="https://thebookof.ai/openai-chat/openai-chat-non-streaming-py/sample-overview/">Code Explantion</a>
...
* Generate, build, and run a sample
  ```
    ...
    python main.py
  ```
* <a href ="https://thebookof.ai/openai-chat/openai-chat-functions-py/sample-overview/">Code Explantion</a>
